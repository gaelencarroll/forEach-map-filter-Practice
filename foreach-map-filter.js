...
function showFirstAndLast(arr){
    const firstLast = arr.map(function(word){
...
function valTimesIndex(arr){
    const numTimesIndex = arr.map(function(num){
...
function extractKey(arr, key){
    const keys = arr.map(function(value){
        return value.name;
    })
    return keys;
}
...
function filterByValue(arr, key) {
    const valueFilter = arr.filter(function(value){
...
function find(arr, searchValue) {
    const findNum = arr.filter(function(value){
...
function removeVowels(str) {
    ...
    const vowels = 'aeiou';
    const notVowels = lowerCase.filter(function(letters){
